...
**_`также в паке solution есть файл openapi.yaml, в котором прописаны все ручки и модели, которые используются в приложении`_**
...
![img.png](solution/images/img.png)
...
![img_1.png](solution/images/img_1.png)
...
![img_2.png](solution/images/img_2.png)
...
![img_3.png](solution/images/img_3.png)
![img_4.png](solution/images/img_4.png)
...
![backend-db.png](solution/images/backend-db.png)
...
![statistics-db.png](solution/images/statistics-db.png)
...
![image (1).png](solution/images/image%20(1).png)


### Тестирование

Для unit-тестирования я использовал java библиотеку JUnit5. Все тесты находятся в папке `/backend/src/test/java`.
